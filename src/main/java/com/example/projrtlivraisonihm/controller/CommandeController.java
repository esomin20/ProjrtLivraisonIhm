...
public class CommandeController {
    ...
    public ResponseEntity<commande> getCommandeById(@PathVariable int id) {
        commande foundCommande = serviceCommande.trouverCommandeParId(id);
    ...
    @PostMapping("/{idCommande}/affecterClient/{idClient}")
    public ResponseEntity<commande> affecterCommandeAClient(@PathVariable Long idCommande, @PathVariable Long idClient) {
        try {
            commande updatedCommande = serviceCommande.affecterCommandeAClient(idCommande, idClient);
